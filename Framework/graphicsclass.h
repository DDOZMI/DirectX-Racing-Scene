...
public:
	...
	void SetModelCollisionEnabled(int modelIndex , bool enabled);

	void ToggleCollisionSystem();

	// 사운드 관련 함수 추가
	void SetSoundVolume(int volume);
	bool IsSoundEnabled() const { return m_soundEnabled; }
	void ToggleSound() { m_soundEnabled = !m_soundEnabled; }
...
private:
	...
	bool IsPositionValid(const XMFLOAT3& , int excludeModelIndex = -1);
